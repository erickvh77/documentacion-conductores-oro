...
function buildSheetRow(record: RecordWithRelations, pdfUrl: string): SheetRowData {
  ...
  return {
    ...
    cumplidoEntregado: itemSiNo("CUMPLIDO"),
    cumplidoUrlFoto: itemUrl("CUMPLIDO"),
    ...
    observaciones: "",
    // Agencias y fechas por documento (inline con cada grupo)
    agenciaLiquidacion: itemAgency("LIQUIDACION"),
    fechaLiquidacion: itemDate("LIQUIDACION"),
    agenciaCumplido: itemAgency("CUMPLIDO"),
    fechaCumplido: itemDate("CUMPLIDO"),
